...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>請選擇店家</h2>
        <div id="d1">
            <asp:ImageButton ID="Imgbtn50Lan" runat="server" ImageUrl="~/Img/50lan.png" OnClick="Imgbtn50Lan_Click" Width="100px" />
        </div>
        <div id="d2">
            <asp:ImageButton ID="ImgbtnWhiteAlley" runat="server" ImagrUrl="" ImageUrl="~/Img/WHITE ALLEY.jpg" OnClick="ImgbtnWhiteAlley_Click" Width="100"/>
        </div>
        <div id="d3">
            <asp:ImageButton ID="ImgbtnMilkshop" runat="server" ImagrUrl="" ImageUrl="~/Img/Milkshop.jpg" OnClick="ImgbtnMilkshop_Click" Width="100"/>
        </div>
